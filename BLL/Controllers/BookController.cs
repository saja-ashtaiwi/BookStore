...
namespace YtBookStore.Controllers
{
    public class BookController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            model.PublisherList = publisherService.All.Select(a => new SelectListItem { Text = a.PublisherName, Value = a.Id.ToString() }).ToList();
        ...
        public IActionResult Create(Book model)
        {
            ...
            model.PublisherList = publisherService.All.Select(a => new SelectListItem { Text = a.PublisherName, Value = a.Id.ToString(),Selected=a.Id==model.PubhlisherId }).ToList();
